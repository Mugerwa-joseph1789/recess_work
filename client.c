...
int main(int argc, char *argv[]){
    int Choose;
    int len=70;
    char *district[70]={"Kalangala", "Kampala", "Kayunga", "Kiboga", "Luwero", "Masaka", "Mityana", "Mpigi", 
    ...
    "Kibaale", "Kabingo", "Kiruhura", "Kisoro", "Kyenjojo", "Masindi", "Mbarara", "Ntungamo", "Rukungiri"};
    if (argc != 2){
        printf("\nUsage:%s <ip server>\n",argv[2]);
    }
